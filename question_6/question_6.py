...
ScimEn_energy_GDP_merge["SelfCite_Ratio"] = (
    ScimEn_energy_GDP_merge["Self-citations"] / ScimEn_energy_GDP_merge["Citations"]
)
ScimEn_energy_GDP_merge["SelfCite_Ratio"] = ScimEn_energy_GDP_merge["SelfCite_Ratio"].round(3)
ScimEn_energy_GDP_merge.to_excel("merge_with_new_col.xlsx", index=False)
